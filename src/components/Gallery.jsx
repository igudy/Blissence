...
const Gallery = () => {
  return (
    <div className="py-12 bg-gray-50 font-playfair text-[#422A3C] text-center">
      ...
      <p className="text-gray-500 font-manrope max-w-xl mx-auto mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:auto-rows-[200px] gap-4 max-w-5xl mx-auto px-4">
        {gallery.map((gallery, index) => (
          <div
            ...
            //   overflow-hidden
              ${index !== 1 && index !== 3 ? "" : ""}
              ${index === 0 ? "rounded-tl-[50px] rounded-bl-[50px] md:col-span-1 md:row-span-2" : ""}
              ${index === 2 ? "rounded-tr-[50px]" : ""}
              ${index === 4 ? "rounded-br-[50px]" : ""}
            `}
          >
            <img
              src={gallery.src}
