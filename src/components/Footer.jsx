      ...
      <div className="max-w-7xl mx-auto px-4 md:px-32 py-10">
        ...
        <div className="grid grid-cols-3 px-3 sm:grid-cols-1 md:grid-cols-3 gap-8 mt-10 sm:text-sm text-[10px] text-[#ccc]">
          ...
          <div className="text-left sm:text-left">
            <h3 className="text-base font-playfair font-semibold mb-4">Explore</h3>
            <ul className="space-y-2">
            <li>
                  <Link to="/" className="hover:underline hover:text-white transition">Home</Link>
                </li>
                <li>
                  <Link to="/about" className="hover:underline hover:text-white transition">About Us</Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:underline hover:text-white transition">Services</Link>
                </li>
                <li>
                  <Link to="/" className="hover:underline hover:text-white transition">Blog</Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:underline hover:text-white transition">Contact Us</Link>
                </li>
            </ul>
          </div>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-base sm:text-lg font-playfair font-semibold mb-4">Utility Pages</h3>
          ...
          <div className="text-right sm:text-center md:text-left mr-3 sm:mr-0 md:mr-0">
            <h3 className="text-base sm:text-lg font-playfair font-semibold mb-4 ">Keep in Touch</h3>
